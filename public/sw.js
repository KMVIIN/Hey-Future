...
self.addEventListener('push',(event)=>{
  ...
  const options={body:data.body||'Future has something for you.',icon:'/icon-192.png',badge:'/icon-192.png',tag:data.tag||'future-alert',renotify:true,data:{url:data.url||'/'}};
